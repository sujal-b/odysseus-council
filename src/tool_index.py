...
BUILTIN_TOOL_DESCRIPTIONS: Dict[str, str] = {
    ...
    "read_file": "Read a bounded file window. Large path-only reads return a structural index; use grep, query, or offset/limit for relevant excerpts. Never injects a whole large file into model context.",
